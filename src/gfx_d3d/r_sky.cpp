...
void __cdecl R_SetSunFromDvars(sunflare_t *sun)
{
    ...
    sun->spriteMaterial = Material_RegisterHandle((char *)(uintptr_t)r_sunsprite_shader->current.integer, 6);
    sun->spriteSize = r_sunsprite_size->current.value;
    sun->flareMaterial = Material_RegisterHandle((char *)(uintptr_t)r_sunflare_shader->current.integer, 6);
